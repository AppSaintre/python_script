...
print('GPU Calculation Time detail1:',g1/2)
print('GPU Calculation Time detail2:',g2/2)
print('GPU-singlemode Download Time:',singledw)
print('CPU-mode Readback Time:',cpumrb)
print('Free Memory Time:',ft)
print('Total:',init+cpucalc+g1/2+g2/2+singledw+cpumrb+ft)